  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post(
        "https://localhost:7152/api/Login/Users",
        {
          email: email,
          password: password,
        }
      ...
      <section className="d-flex justify-content-center align-items-center">
        <div className="row">
          ...
          <div className="col-lg-7 d-none d-lg-block p-0">
            <img
              src="https://img.freepik.com/free-vector/tablet-login-concept-illustration_114360-7863.jpg?size=626&ext=jpg&ga=GA1.1.99625817.1684863857&semt=sph"
              alt="Login"
              className="w-100 img-fluid"
            />
          </div>
          {/* Form column */}
          <div className="col-lg-5 col-12 p-4 mt-2" id="form">
            <form>
